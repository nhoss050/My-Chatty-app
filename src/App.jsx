    ...
    this.socket.onmessage = (event) => {
      ...
      switch(incomingData.type) {
        ...
        case "incomingMessage":
            ...
            const newMessage = {type :incomingData.type, username: incomingData.username, content: incomingData.content, id: incomingData.id, color:incomingData.color, photo:incomingData.image  };
